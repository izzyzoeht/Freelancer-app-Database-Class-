...
import { tradespeopleApi, jobsApi } from '@/lib/api'
...
export default function JuniorDashboard() {
  ...
  const endorseLinked  = !!tp?.endorse_id
  ...
  const steps = [
    ...
    { n: 2, label: 'Request senior endorsement',                      done: endorseLinked,  href: '/junior/setup' },
    { n: 3, label: 'Get verified by supervisor',                      done: isVerified,     href: '/junior/setup' },
    { n: 4, label: 'Start accepting jobs (within job cap)',           done: hasAcceptedJob, href: '/junior/jobs' },
  ]
