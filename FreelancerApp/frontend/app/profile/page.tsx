...
export default function ProfilePage() {
  ...
  // Tradesperson-specific fields (visible only if user_type = Tradesperson or Junior)
  ...
  function handleSave(e: React.FormEvent) {
    e.preventDefault()
    // → PUT /api/users/profile  (add to lib/api.ts once backend route exists)
    setSaved(true)
      ...
      <div className="p-8 max-w-2xl mx-auto animate-fade-up">
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4">
            <button type="submit"
              className="px-8 py-3 bg-brand-navy text-white font-semibold rounded-xl hover:bg-brand-steel transition-colors">
              Save changes
            </button>
